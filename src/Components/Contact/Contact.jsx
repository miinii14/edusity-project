...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "cd4b71c6-81d1-4ffa-baaf-900d1c6ed29d");
    ...
    <div className='contact container'>
      <div className="contact-col">
        ...
        <ul>
          ...
          <li><img src={location_icon} alt="" />77 Massauchusetts Ave, Cambridge <br /> Ma 02139, United States</li>
        </ul>
      </div>
      <div className="contact-col">
